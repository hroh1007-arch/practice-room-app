    ...
    <div className={`relative ${className}`} onKeyDown={handleKeyDown}>
      ...
      {open && (
        <div
          ...
          className="absolute left-0 top-full z-50 mt-2 w-[360px] max-w-[calc(100vw-2rem)] rounded-xl border border-gray-300 bg-white p-4 shadow-2xl"
        >
          <div className="mb-4 flex items-center justify-between gap-3">
            <button
              ...
              className="h-9 w-9 rounded-lg border text-xl leading-none hover:bg-gray-100"
            >
              ‹
            </button>

            <div className="text-center">
              <div className="text-lg font-semibold text-gray-900">{formatMonth(cursor)}</div>
              <div className="text-sm text-gray-500">{formatDisplayDate(cursor)}</div>
            </div>
              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    focused && !selected ? "border-gray-900 ring-2 ring-blue-500" : "",
